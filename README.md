...
Agnetic OS is a local-first, AI-native operating system where three autonomous agents communicate through a NATS/JetStream message bus, execute tools in a sandboxed environment, and render a real-time web dashboard. No cloud dependencies. No telemetry leakage. Everything runs on your hardware.
...
That's it. Open `http://localhost:8899` for the dashboard, or use `agneticctl` for CLI control.
